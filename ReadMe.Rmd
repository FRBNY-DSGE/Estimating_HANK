...
* `/data/input_data/raw` gives paths to inputs required for estimation, where ... (not sure if necessary so not gonna flush out)
...
* `/data/output_data/smets_wouters/ss0/estimate/work` contains () not really sure yet
