...
For the latter, also see `?smc2`. Most of the
...
- `old_cloud::Union{ParticleCloud, Cloud, SMC.Cloud} = Cloud(m, 0)`: old Cloud object
...
function estimate(m::Union{AbstractDSGEModel,AbstractVARModel}, df::DataFrame;
                  ...
                  old_cloud::Union{ParticleCloud, Cloud,
                                   SMC.Cloud} = ParticleCloud(m, 0),
