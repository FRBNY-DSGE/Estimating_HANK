"""
```
function old_to_new_cloud(cloud::Cloud)::SMC.Cloud
```
...
function Cloud(cloud::SMC.Cloud)
    return Cloud(cloud.particles, cloud.tempering_schedule,
                     cloud.ESS, cloud.stage_index, cloud.n_Φ, cloud.resamples,
                     cloud.c, cloud.accept, cloud.total_sampling_time)
end
function SMC.Cloud(cloud::Cloud)
    return SMC.Cloud(cloud.particles, cloud.tempering_schedule,
                     cloud.ESS, cloud.stage_index, cloud.n_Φ, cloud.resamples,
                     cloud.c, cloud.accept, cloud.total_sampling_time)
end
